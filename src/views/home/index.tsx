              ...
              <div className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                ...
                <div>
                  <span className="text-primary bg-primary/20 rounded-md px-3 py-1 text-sm font-medium uppercase tracking-wider">
                    SOLANA TOBRUTS CREATOR v{pkg.version}
                  </span>
                  <h1 className="md:text-5xl/tight my-4 max-w-lg text-4xl font-medium text-white">
                    Create ToBruts Without Code
                  </h1>
                  <p className="text-default-300 md:text-lg">
                    Create your own Solana tobruts using all in one Solana
                    tobruts creator.
                  </p>
                  <div className="new_add_css">
                    <a
                      onClick={() => setOpenCreateModal(true)}
                      className="cursor-pointer hover:bg-primary-hover pe-4 group mt-10 inline-flex items-center justify-center gap-2 rounded-full border border-white/10 pl-1 pr-4 py-1 text-white transition-all duration-300"
                    >
                    ...
                    <div className="relative m-auto flex flex-col gap-6 overflow-hidden">
                      <div className="marquee-hero flex min-h-full flex-shrink-0 flex-col items-center justify-around gap-6">
                        {[
                          ...
                          <img
                            key={index}
                            src={`./assets/images/tobruts/${image}.png`}
                            alt=""
                            className="aspect-1 h-full w-60 rounded-xl object-cover border-2 border-primary"
                          />
                        ))}
                      </div>
                      <div
